...
function church_tithe_wp_stripe_webhook_customer_subscription_deleted( $webhook_data ) {
	...
	// If arrangement was found, cancel it. This handles subscriptions that are done because the payment failed.
	$cancellation_result = church_tithe_wp_cancel_stripe_subscription( $arrangement, $reason );
